...
const numArray = [1, 200, 3, 45, 50]
const sumAverageArray = function(numArray) {
    const totalNumArray = numArray[0] + numArray[1] + numArray[2] + numArray[3] + numArray[4];
    return Math.round(totalNumArray/numArray.length);
}
console.log(sumAverageArray(numArray));